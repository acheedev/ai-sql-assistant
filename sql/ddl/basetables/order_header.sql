CREATE TABLE order_header (
    ...
    CONSTRAINT order_header_uk1 UNIQUE ( order_number ),
    CONSTRAINT order_header_chk1 CHECK ( order_total_amount >= 0 ),
    CONSTRAINT order_header_fk1 FOREIGN KEY ( customer_account_id )
        REFERENCES customer_account ( customer_account_id ),
    CONSTRAINT order_header_fk2 FOREIGN KEY ( status_code )
