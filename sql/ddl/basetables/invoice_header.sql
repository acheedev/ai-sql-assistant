CREATE TABLE invoice_header (
    ...
    CONSTRAINT invoice_header_uk1 UNIQUE ( invoice_number ),
    CONSTRAINT invoice_header_chk1 CHECK ( invoice_total_amount >= 0 ),
    CONSTRAINT invoice_header_fk1 FOREIGN KEY ( order_id )
        REFERENCES order_header ( order_id ),
    CONSTRAINT invoice_header_fk2 FOREIGN KEY ( customer_account_id )
        REFERENCES customer_account ( customer_account_id ),
    CONSTRAINT invoice_header_fk3 FOREIGN KEY ( status_code )
