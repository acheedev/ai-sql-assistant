CREATE TABLE t_inventory_balance (
    ...
    CONSTRAINT t_inventory_balance_uk1 UNIQUE ( product_sku_id,
                                                location_code ),
    CONSTRAINT t_inventory_balance_chk1 CHECK ( quantity_on_hand >= 0 ),
    CONSTRAINT t_inventory_balance_chk2 CHECK ( reorder_threshold >= 0 ),
    CONSTRAINT t_inventory_balance_fk1 FOREIGN KEY ( product_sku_id )
        REFERENCES t_product_sku ( product_sku_id ),
    CONSTRAINT t_inventory_balance_fk2 FOREIGN KEY ( status_code )
