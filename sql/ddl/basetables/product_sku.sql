CREATE TABLE product_sku (
    ...
    CONSTRAINT product_sku_uk1 UNIQUE ( sku_code ),
    CONSTRAINT product_sku_chk1 CHECK ( unit_price >= 0 ),
    CONSTRAINT product_sku_fk1 FOREIGN KEY ( product_id )
        REFERENCES product_master ( product_id ),
    CONSTRAINT product_sku_fk2 FOREIGN KEY ( status_code )
