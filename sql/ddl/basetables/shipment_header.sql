CREATE TABLE shipment_header (
    ...
    CONSTRAINT shipment_header_uk1 UNIQUE ( shipment_number ),
    CONSTRAINT shipment_header_chk1 CHECK ( shipment_total_amount >= 0 ),
    CONSTRAINT shipment_header_fk1 FOREIGN KEY ( order_id )
        REFERENCES order_header ( order_id ),
    CONSTRAINT shipment_header_fk2 FOREIGN KEY ( status_code )
        REFERENCES status_code_lookup ( status_code ),
    CONSTRAINT shipment_header_fk3 FOREIGN KEY ( ship_to_address_id )
