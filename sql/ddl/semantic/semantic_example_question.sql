CREATE TABLE semantic_example_question (
    ...
    CONSTRAINT semantic_example_question_fk1 FOREIGN KEY ( preferred_object_name )
        REFERENCES semantic_object ( object_name ),
    CONSTRAINT semantic_example_question_chk1 CHECK ( is_enabled IN ( 'Y',
                                                                      'N' ) )
);
